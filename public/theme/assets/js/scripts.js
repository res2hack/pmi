...
$(function() {
  ...
  var toggle_sidebar_mini = function(mini) {
    ...
    if(!mini) {
	  ...
	  $("#iconMenu").removeClass('fas fa-chevron-right');
	  $("#iconMenu").addClass('fas fa-chevron-left');
    }else{
      body.addClass('sidebar-mini');
      body.removeClass('sidebar-show');
	  $("#iconMenu").removeClass('fas fa-chevron-left');
	  $("#iconMenu").addClass('fas fa-chevron-right');
