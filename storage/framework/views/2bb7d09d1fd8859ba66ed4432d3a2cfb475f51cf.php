...
<form method="post" action="<?php echo e(route('konsultasi_update')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control font-weight-500 border-form bg-form h-45"
                            name="nmJudul" value="<?php echo e($konsultasi->judul); ?><?php echo e(old('nmJudul')); ?>" required>
                        ...
                        <select name="nmKategori" id="nmKategori" class="form-control select2 w-100" required>
                            ...
                            <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kat->jenis_id); ?>" 
                                    <?php if($kat->jenis_id === $konsultasi->kategori_id): ?> selected <?php endif; ?>>
                                    <?php echo e($kat->name); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        ...
                        class="form-control bg-form border-form"><?php echo e($konsultasi->konten); ?><?php echo e(old('nmPertanyaan')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/konsultasi/edit.blade.php ENDPATH**/ ?>