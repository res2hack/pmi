...
<script>
    ...
    var table = $('#dt-master').DataTable({
        ...
        serverSide: true,
        ajax: {
                url: '<?php echo e(route('bandara_json')); ?>',
                data: function (d) {
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/master/bandara/table.blade.php ENDPATH**/ ?>