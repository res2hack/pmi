...
<script>
    ...
    $(document).ready(function() {
        ...
        var kota = <?php echo $jdkeberangkatan->kabkota?:0; ?>;

        var url =  "<?php echo e(route('jadwal_keberangkatan_get_kab')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = <?php echo $jdkeberangkatan->kecamatan?:0; ?>;
        var url =  "<?php echo e(route('jadwal_keberangkatan_get_kecamatan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var desa = <?php echo $jdkeberangkatan->desa?:0; ?>;
        var url =  "<?php echo e(route('jadwal_keberangkatan_get_desa')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var pekerjaan = <?php echo $jdkeberangkatan->pekerjaan?:0; ?>;
        var url =  "<?php echo e(route('jadwal_keberangkatan_get_pekerjaan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/jadwal/keberangkatan/script-edit.blade.php ENDPATH**/ ?>