...
<div class="row">
    ...
    <div class="col-11">
        ...
        <span class="font-weight-500 text-primary">Pencaker Baru</span>
...
<form method="post" action="<?php echo e(route('pencaker_store')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pencaker/create.blade.php ENDPATH**/ ?>