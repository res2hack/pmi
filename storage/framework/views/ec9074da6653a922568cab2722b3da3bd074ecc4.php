...
<script>
    ...
    $(document).ready(function() {
        ...
        var kota = <?php echo $pengaduan->kabkota?:0; ?>;
        var url =  "<?php echo e(route('pengaduan_get_kab')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = <?php echo $pengaduan->kecamatan?:0; ?>;
        var url =  "<?php echo e(route('pengaduan_get_kecamatan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var desa = <?php echo $pengaduan->desa?:0; ?>;
       
        var url =  "<?php echo e(route('pengaduan_get_desa')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var pekerjaan = <?php echo $pengaduan->pekerjaan?:0; ?>;
        
        var url =  "<?php echo e(route('pengaduan_get_pekerjaan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var url =  "<?php echo e(route('pengaduan_pptkis')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
                nmPptkis: $('select[name=nmPptkis]').val(),
            },
            dataType : "json",
            success:function(data)
            {
            $('textarea[name="nmAlamatPptkis"]').empty();
            $('textarea[name="nmAlamatPptkis"]').val(data.alamat + ', ' + data.telepon);
...
<?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pengaduan/script-edit.blade.php ENDPATH**/ ?>