...
<script>
    ...
    $(document).ready(function() {
        ...
        var kota = <?php echo $kedatangan->kabkota?:0; ?>;

        var url =  "<?php echo e(route('kedatangan_get_kab')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = <?php echo $kedatangan->kecamatan?:0; ?>;
        var url =  "<?php echo e(route('kedatangan_get_kecamatan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var desa = <?php echo $kedatangan->desa?:0; ?>;
        var url =  "<?php echo e(route('kedatangan_get_desa')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var pekerjaan = <?php echo $kedatangan->pekerjaan?:0; ?>;
        var url =  "<?php echo e(route('kedatangan_get_pekerjaan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/kedatangan/script-edit.blade.php ENDPATH**/ ?>