...
function getPelatihan() {
    ...
    var table = $('#dt-penerimaan').DataTable({
        ...
        serverSide: true,
        ajax: {
                url: '<?php echo e(route('penerimaan_index_json')); ?>',
                data: function (d) {
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/penerimaan/table.blade.php ENDPATH**/ ?>