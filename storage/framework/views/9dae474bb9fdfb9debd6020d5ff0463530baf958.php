...
<div class="float-left mr-3">
    <a href="<?php echo e(route('lsp_create')); ?>" class="btn btn-primary font-15 py-2" title="Buat Data LSP Baru">
...
<?php $__env->startSection('modal'); ?>
    ...
    <form method="POST" action="<?php echo e(route('lsp_delete')); ?>">
        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/direktori/lsp/index.blade.php ENDPATH**/ ?>