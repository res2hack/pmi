        ...
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Data Pelamar</h4> 
            ...
            <div class="btn-group  align-top ml-2 mr-2" title="Menu">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="<?php echo e(route('pelamar_detail', $pelamar->id)); ?>" class="text-primary dropdown-item" title="Ubah Data SIP"><i class="far fa-file-alt mr-2 font-12"></i>Detail
                    </a>
                </div>
            </div>
        </div>
            ...
            <span class="font-weight-500 text-primary"><?php echo e($pelamar->name); ?></span>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<i class="fas fa-angle-right mx-2"></i>
<a href="<?php echo e(route('pelamar_detail', $pelamar->id)); ?>"><u><?php echo e($pelamar->name); ?></u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="<?php echo e(route('pelamar_update')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>

<input type="hidden" name="nmTipe" value="edit">
<input type="hidden" name="nmID" value="<?php echo e($pelamar->id); ?>">
        ...
        <div class="row mt-3">
            <div class="col-md-6 pb-0 border-right">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        value="<?php echo e($pelamar->tgl_registrasi); ?><?php echo e(old('nmTglRegistrasi')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500" 
                        value="<?php echo e($pelamar->name); ?><?php echo e(old('nmPelamar')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500" 
                        value="<?php echo e($pelamar->nik); ?><?php echo e(old('nmNIK')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500" 
                        value="<?php echo e($pelamar->bpjs); ?><?php echo e(old('nmBPJS')); ?>">
                    ...
                    <div class="col-md-9 mt-1">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdLaki" name="nmJK" class="custom-control-input" 
                                    value="L" <?php if($pelamar->jk === "L"): ?> checked <?php endif; ?>>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdPerempuan" name="nmJK" class="custom-control-input" 
                                value="P" <?php if($pelamar->jk === "P"): ?> checked <?php endif; ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500" 
                        value="<?php echo e($pelamar->tgl_lahir); ?><?php echo e(old('nmTglLahir')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500"><?php echo e($pelamar->kontak); ?></textarea>
                            ...
                            <select name="nmAgama" id="nmAgama" class="form-control select2 w-100">
                                ...
                                <?php $__currentLoopData = $agama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($agm->id); ?>" 
                                        <?php if($pelamar->agama_id === $agm->id): ?> selected <?php endif; ?>>
                                        <?php echo e($agm->nama); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500" 
                        value="<?php echo e($pelamar->email); ?><?php echo e(old('nmEmail')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <textarea id="nmAlamat" name="nmAlamat" rows="2"
                        class="form-control h-45 border-form bg-form font-weight-500"><?php echo e($pelamar->alamat); ?></textarea>
                        ...
                        <select name="nmProvinsi" id="nmProvinsi" onchange="getKota();" class="form-control select2 w-100">
                            ...
                            <?php $__currentLoopData = $provinsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prov->id); ?>"
                                    <?php if($pelamar->provinsi_id === $prov->id): ?> selected <?php endif; ?>>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div>
                            <select name="nmPendidikan" id="nmPendidikan" class="form-control select2 w-100">
                                ...
                                <?php $__currentLoopData = $pendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pdk->id); ?>" <?php if($pelamar->pendidikan_id === $pdk->id): ?> selected <?php endif; ?>>
                                        <?php echo e($pdk->nama); ?>
                        ...
                        <div class="mt-2">
                            ...
                            class="form-control h-45 border-form bg-form font-weight-500"><?php echo e($pelamar->jurusan); ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <div>
                            <select name="nmLowongan" id="nmLowongan" class="form-control select2 w-100">
                                ...
                                <?php $__currentLoopData = $lowongan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $low): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($low->id); ?>" <?php if($pelamar->sip_id === $low->id): ?> selected <?php endif; ?>>
                ...
                <div class="form-group row">
                        ...
                        <?php if($pelamar->foto): ?>
                            ...
                            <div class="mt-3">
                                ...
                                <a id="hapusFoto" class="text-primary font-13" style="cursor:pointer;"
                                    ...
                                    $('#fotoUndo').show();$('#statusFoto').val('<?php echo e($pelamar->foto); ?>');">
                                ...
                                <a id="fotoUndo" style="cursor:pointer;display:none;" 
                                    ...
                                    $('#image-preview2').css('background-image', 'url(<?php echo e(url($pelamar->foto)); ?>)');
                    ...
                    <div class="col-9">
                        <?php if($pelamar->foto): ?>
                            <div id="image-preview2" class="image-preview" <?php if($pelamar->foto): ?> style="background-image: url('<?php echo e(url($pelamar->foto)); ?>');background-repeat: no-repeat;background-size: cover;" <?php endif; ?>>
                    ...
                    <div class="col-md-9">
                        ...
                        <?php if($pelamar->cv): ?>
                            <div id="idLampiran" class="mb-2">
                                <a href="<?php echo e(url($pelamar->cv)); ?>" target="_blank" class="font-weight-bold mr-3 font-15">
                                    <u><?php echo e(str_replace("uploads/file/pmi/cv/", "", $pelamar->cv)); ?></u>
                                </a> 
                                <a style="cursor:pointer;" onclick="$('#idCV').show();$('#idLampiran').hide();
                                    $('#statusCV').val('<?php echo e($pelamar->cv); ?>');">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form font-weight-500"><?php echo e($pelamar->keterangan); ?></textarea>
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input"  id="cbKompetensi" 
                                    name="nmKompetensi" <?php if($pelamar->syarat_kompetensi === "Y"): ?> checked <?php endif; ?>>
                        ...
                        <div class="custom-control mt-2 custom-checkbox">
                            <input type="checkbox" class="custom-control-input"  id="cbSehat" 
                                name="nmSehat" <?php if($pelamar->syarat_sehat === "Y"): ?> checked <?php endif; ?>>
                        ...
                        <div class="custom-control mt-2 custom-checkbox">
                            <input type="checkbox" class="custom-control-input"  id="cbDokumen" 
                                name="nmDokumen" <?php if($pelamar->syarat_dokumen === "Y"): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('sistem.pelamar.script-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
    function beriLogin() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelamar/edit.blade.php ENDPATH**/ ?>