...
<div class="row">
    ...
    <div class="col-11">
        <div class="mb-1 text-dark"><h4 class="d-inline">Master Data Masalah</h4> 
            <span class="ml-2 font-11 bg-dark rounded text-white align-top py-1 px-2">Indeks</span></div>
            
        <span class="font-weight-500 text-primary">Daftar Masalah</span>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<span class="font-weight-500">Masalah</span>
<?php $__env->stopSection(); ?>
        ...
        <form method="POST" action="<?php echo e(route('master_store')); ?>">
            ...
            <div class="card shadow border-top5 border-form ">
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <input type="hidden" name="nmJenisKategori" value="m_masalah">

                    
                    <div class="form-group">
                        <div class="font-weight-bold font-16 mb-2 text-dark">Nama Masalah</div>
                ...
                <div class="mt-2 table-responsive ">
                    <table id="dt-master" class="table w-100">
                        <thead>
                            <tr>
                                <th style="width:5%;">#</th>
                                <th class="font-15">Nama Masalah</th>
                                <th></th>
                            </tr>
                        </thead>
                    </table>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo $__env->make('sistem.master.masalah.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Wamp.NET\sites\disnaker2021\pmi\resources\views/sistem/master/masalah/index.blade.php ENDPATH**/ ?>