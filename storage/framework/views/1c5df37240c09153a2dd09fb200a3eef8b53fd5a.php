...
<script>
    function dataPendaftar() {
        ...
        var table = $('#dt-sertifikasi').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('pelatihan_sertifikasi_detail_json')); ?>',
                    data: {
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/sertifikasi/detail-table.blade.php ENDPATH**/ ?>