...
<form method="post" action="<?php echo e(route('p3mi_store')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 my-1 font-weight-bold text-dark">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdPusat" name="nmKantor" class="custom-control-input" value="p3mi-pusat" checked>
                            <label class="custom-control-label" style="cursor:pointer;" for="rdPusat">Pusat</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdCabang" name="nmKantor" class="custom-control-input" value="p3mi-cabang">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/direktori/p3mi/create.blade.php ENDPATH**/ ?>