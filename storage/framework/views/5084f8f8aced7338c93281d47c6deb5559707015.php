...
<div class="row">
    <div class="col-md-4">
        <form method="POST" action="<?php echo e(route('category_store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="card shadow border-top5 border-form ">
                ...
                <div class="card-body mt-0 pb-1 ">
                    <div class="form-group">
                        ...
                        <input type="text"  id="nmKategori" name="nmKategori" class="form-control bg-form h-45 border-form" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="nmDeskripsi" class="form-control bg-form h-45 border-form" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        <div class="font-weight-bold font-16 mb-2 text-dark">Slug</div>
                        <input type="text" id="nmJenisKategori" name="nmJenisKategori" class="form-control bg-form h-45 border-form">
    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <form action="<?php echo e(route('category_search')); ?>" class="d-inline ">
                    ...
                    <div class="col-md-6">
                        <span class="float-right"><?php echo e($cat_simple->links()); ?></span> 
                    </div>
                    
                </div>

                <?php if($cat_paginate->total() < 11): ?>
                ...
                <?php endif; ?>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $cat_paginate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="py-2 font-14"><?php echo e($x->deskripsi); ?></td>
                                <td class="py-2">/<?php echo e($x->slug); ?></td>
                                <td class="py-2 font-14">
                                    <a class="mr-1" href="<?php echo e(route('category_edit', $x->id )); ?>" title="Ubah Kategori"><i class="fas fa-edit"></i></a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php echo e($cat_paginate->links()); ?>

                    </div>
                    <div class="col-md-6 text-right pt-2">
                        <?php if($cat_paginate->count() > 0): ?>
                        <span class="font-weight-bold">
                        Menampilkan <?php echo e(($cat_paginate->currentpage()-1)* $cat_paginate->perpage() + 1); ?>-<?php echo e(($cat_paginate->currentpage()-1)* $cat_paginate->perpage() + $cat_paginate->count()); ?> dari <?php echo e($cat_paginate->total()); ?> Kategori
                        </span>
                        <?php endif; ?>
                    </div>
                </div>
...
<form method="POST" action="<?php echo e(route('category_delete_index')); ?>">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/categories/index.blade.php ENDPATH**/ ?>