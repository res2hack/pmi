...
Ubah - Kelola Data Master Provinsi
...
<div class="row">
    ...
    <div class="col-11">
        ...
        <span class="font-weight-500 text-primary">Ubah Data Provinsi</span>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<a href="<?php echo e(route('provinsi_index')); ?>"><u>Provinsi</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<div class="row">
    <div class="col-md-4">
        <form method="POST" action="<?php echo e(route('provinsi_update', $provinsi->id)); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="nmStatus" value="edit">
            <input type="hidden" name="nmID" value="<?php echo e($provinsi->id); ?>">
            <div class="card shadow border-top5 border-form ">
                <div class="card-body mt-0 pb-1 ">

                    <div class="form-group">
                        <div class="font-weight-bold font-16 mb-2 text-dark">Nama Provinsi</div>
                        <input type="text"  id="nmProvinsi" name="nmProvinsi" value="<?php echo e($provinsi->nama); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/master/provinsi/edit.blade.php ENDPATH**/ ?>