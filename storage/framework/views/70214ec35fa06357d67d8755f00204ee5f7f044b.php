...
<script>
    ...
    var table = $('#dt-master').DataTable({
        ...
        serverSide: true,
        ajax: {
                url: '<?php echo e(route('konsultasi_kategori_json')); ?>',
                data: function (d) {
...
</script><?php /**PATH C:\Wamp.NET\sites\disnaker2021\pmi\resources\views/sistem/master/kategori-konsultasi/table.blade.php ENDPATH**/ ?>