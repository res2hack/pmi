                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div id="ArsipPeserta">
                                ...
                                <form id="formExists">
                                    ...
                                    <div>
                                        ...
                                        <input type="hidden" name="nmIDpelatihanExists" value="<?php echo e($pelatihan->id); ?>">
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="nmTglDaftarExists" id="nmTglDaftarExists" 
                                                value="<?php echo e(now()->format('Y-m-d')); ?>" class="form-control font-weight-bold h-42 bg-form border-form">  
                                        </div>
                                       <input type="hidden" name="nmKejuruanExists" value="<?php echo e($pelatihan->kejuruan_id); ?>">
                                    </div>
                                </form>
                            </div>
                            <div id="DaftarBaru" style="display:none;">
                                ...
                                <form id="formPartner">
                                <div class="row">
                                    <input type="hidden" name="nmIDpelatihanBaru" value="<?php echo e($pelatihan->id); ?>">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="nmPassword" type="text" class="form-control bg-form border-form text-form h-42" value="<?php echo e(old('password')); ?>" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                    ...
                                    <input type="hidden" name="nmKejuruanBaru" value="<?php echo e($pelatihan->kejuruan_id); ?>">
                                </div>
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                value="<?php echo e(now()->format('Y-m-d')); ?>" class="form-control bg-form border-form text-form font-weight-bold h-42 ">  
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/pendaftaran/modal-daftar.blade.php ENDPATH**/ ?>