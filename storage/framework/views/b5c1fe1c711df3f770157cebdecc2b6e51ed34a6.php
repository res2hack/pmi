...
<script>
    $(document).ready(function() {
        ...
        let pelatihan_id = <?php echo e($pelatihan->id); ?>;
            ...
            $.ajax({
                type : "POST",
                url :"<?php echo e(route('pelatihan_penerimaan_update')); ?>",
                data: {  
                    nmIdPelatihan: pelatihan_id,
                    nmTerima: terima,
                },
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/penerimaan/script.blade.php ENDPATH**/ ?>