...
<script>
    $(document).ready(function() {
        ...
        let pelatihan_id = <?php echo e($pelatihan->id); ?>;
            ...
            $.ajax({
                type : "POST",
                url :"<?php echo e(route('pelatihan_kelulusan_update')); ?>",
                data: {  
                    nmIdPelatihan: pelatihan_id,
                    nmLulus: lulus,
                },
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/kelulusan/script.blade.php ENDPATH**/ ?>