...
<form method="POST" action="<?php echo e(route('post_restore')); ?>">
    <?php echo csrf_field(); ?>
...
<form method="POST" action="<?php echo e(route('post_delete')); ?>">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/posts/modal-sampah.blade.php ENDPATH**/ ?>