...
<div class="row">
    ...
    <div class="col-11">
        <div class="mb-1 text-dark"><h4 class="d-inline">Pelatihan - Kelulusan</h4> 
            <span class="ml-2 font-11 bg-primary font-weight-bold
                    rounded text-white align-top py-1 px-2">Indeks</span></div>
...
<i class="fas fa-angle-right mx-2"></i>
<span class="font-weight-bold text-dark">Kelulusan</span>
<?php $__env->stopSection(); ?>
                    ...
                    <table id="dt-kelulusan" class="table w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="font-15 text-center">Peserta</th>
                                <th class="font-15 text-center">Lulus</th>
                                <th style="width:5%;"></th>
                            </tr>
                        </thead>
                    </table>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo $__env->make('sistem.pelatihan.kelulusan.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        setTimeout(function()
        { 
            getPelatihan();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/kelulusan/index.blade.php ENDPATH**/ ?>