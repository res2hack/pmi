...
<script>
    ...
    var table = $('#dt-master').DataTable({
        ...
        serverSide: true,
        ajax: {
                url: '<?php echo e(route('pendidikan_json')); ?>',
                data: function (d) {
...
</script><?php /**PATH C:\Wamp.NET\sites\disnaker2021\pmi\resources\views/sistem/master/pendidikan/table.blade.php ENDPATH**/ ?>