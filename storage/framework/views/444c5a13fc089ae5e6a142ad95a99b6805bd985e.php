<script>
    ...
    $(document).ready(function() {
        ...
        var kota = <?php echo $pelamar->kabkota?:0; ?>;

        var url =  "<?php echo e(route('pelamar_get_kab')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = <?php echo $pelamar->kecamatan?:0; ?>;
        var url =  "<?php echo e(route('pelamar_get_kecamatan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelamar/script-edit.blade.php ENDPATH**/ ?>