<form method="POST" action="<?php echo e(route('pelatihan_delete')); ?>">
    <?php echo csrf_field(); ?>
    ...
    </form><?php /**PATH C:\Wamp.NET\sites\disnaker2021\pmi\resources\views/sistem/pelatihan/modal-del.blade.php ENDPATH**/ ?>