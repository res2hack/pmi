...
<a href="<?php echo e(route('master_index', 'negara')); ?>"><u>Negara</u></a>
<i class="fas fa-angle-right mx-2"></i>
            ...
            <div class="card shadow border-top5 border-form ">
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nmName" value="<?php echo e($master->name); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input name="nmKode" value="<?php echo e($master->kode); ?>"
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('sistem.master.negara.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/master/negara/edit.blade.php ENDPATH**/ ?>