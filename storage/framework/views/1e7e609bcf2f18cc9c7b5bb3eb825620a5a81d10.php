<form id="formPelatihanSelesai" method="POST" action="<?php echo e(route('pelatihan_selesai', $pelatihan->id)); ?>">
    <?php echo csrf_field(); ?>
    ...
    </form><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/modal-selesai.blade.php ENDPATH**/ ?>