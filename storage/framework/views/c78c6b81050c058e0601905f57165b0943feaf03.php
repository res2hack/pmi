...
<div class="row">
    <div class="col-md-4">
        <form method="POST" action="<?php echo e(route('kategori_prodesmigratif_update', $kat->id)); ?>">
            <?php echo csrf_field(); ?>
            <div class="card shadow border-top5 border-form ">
                ...
                <div class="card-body mt-0 pb-1 ">
                    <div class="form-group">
                        ...
                        <input type="text"  id="nmKategori" name="nmKategori" value="<?php echo e($kat->name); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/prodesmigratif/kategori-edit.blade.php ENDPATH**/ ?>