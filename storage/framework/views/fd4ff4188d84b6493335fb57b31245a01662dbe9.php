...
<script>
    function dataPendaftar() {
        ...
        var table = $('#dt-penerimaan').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('pelatihan_penerimaan_detail_json')); ?>',
                    data: {
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/penerimaan/detail-table.blade.php ENDPATH**/ ?>