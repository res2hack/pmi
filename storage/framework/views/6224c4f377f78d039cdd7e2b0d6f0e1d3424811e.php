...
<script>
    ...
    $(document).ready(function() {
        ...
        var url =  "<?php echo e(route('partner_get_kabupaten')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = '';
        var url =  "<?php echo e(route('partner_get_kecamatan')); ?>";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    $(document).ready(function() {
        ...
        if(penduduk == null){
            ...
            $.ajax({
                type : "GET",
                url :"<?php echo e(route('pelatihan_pendaftaran_duplikat')); ?>",
                data: {  
                    nmPenduduk: penduduk,
                ...
                success:function(data)
                {
                    ...
                    if(cek_duplikat > 0){
                        ...
                        $.ajax({
                            type : "POST",
                            url :"<?php echo e(route('pelatihan_pendaftaran_store_exists')); ?>",
                            data: {  
                                nmPenduduk: penduduk,
                                nmIDpelatihanExists: idExists,
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type : "POST",
            url :"<?php echo e(route('pelatihan_pendaftaran_store_baru')); ?>",
            data: {    
...
<script>
    ...
    $("#btn-delete-daftar").click(function(e) {
        ...
        $.ajax({
            type : "POST",
            url :"<?php echo e(route('pelatihan_pendaftaran_delete')); ?>",
            data: {  
    ...
    $("#btn-ubah-daftar").click(function(e) {
        ...
        $.ajax({
            type : "POST",
            url :"<?php echo e(route('pelatihan_pendaftaran_update')); ?>",
            data: {  
...
<?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/pendaftaran/script.blade.php ENDPATH**/ ?>