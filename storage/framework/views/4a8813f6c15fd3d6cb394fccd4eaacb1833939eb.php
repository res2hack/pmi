...
<a href="<?php echo e(route('lsp_index')); ?>"><u>LSP</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="<?php echo e(route('lsp_store')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/direktori/lsp/create.blade.php ENDPATH**/ ?>