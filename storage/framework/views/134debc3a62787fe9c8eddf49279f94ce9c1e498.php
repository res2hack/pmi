...
<a href="<?php echo e(route('jadwal_keberangkatan_index')); ?>"><u>Jadwal Keberangkatan</u></a>
<i class="fas fa-angle-right mx-2"></i>
<a href="<?php echo e(route('jadwal_keberangkatan_detail', $jdkeberangkatan->id)); ?>"><u><?php echo e($jdkeberangkatan->name); ?></u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="<?php echo e(route('jadwal_keberangkatan_update')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>

<input type="hidden" name="nmStatus" value="edit">
<input type="hidden" name="nmID" value="<?php echo e($jdkeberangkatan->id); ?>">

<div class="card shadow  border-top5 border-form">
    <div class="card-body">
        <div class="text-right">
            <a href="<?php echo e(route('jadwal_keberangkatan_detail', $jdkeberangkatan->id)); ?>" title="Batal Ubah Data"
        ...
        <div class="row mt-3">
            <div class="col-md-6 border-right border-form">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        value="<?php echo e(\Carbon\Carbon::parse($jdkeberangkatan->tgl_berangkat)->format('Y-m-d\TH:i:s')); ?>"
                    ...
                    <div class="col-md-9">
                        <select name="nmPesawat" id="nmPesawat" class="form-control select2 w-100" required>
                            ...
                            <option value="<?php echo e($pes->jenis_id); ?>" 
                                <?php if($pes->jenis_id === $jdkeberangkatan->pesawat_id): ?> selected <?php endif; ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control font-weight-500 border-form bg-form h-45"
                            name="nmNoPenerbangan" value="<?php echo e($jdkeberangkatan->no_penerbangan); ?>" required>
                        ...
                        <select name="nmBandaraAsal" id="nmBandaraAsal" class="form-control select2 w-100" required>
                            ...
                            <?php $__currentLoopData = $bandara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bd_asal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($bd_asal->jenis_id); ?>"
                                    <?php if($bd_asal->jenis_id === $jdkeberangkatan->bandara_asal): ?> selected <?php endif; ?>>
                    ...
                    <div class="col-md-9">
                        <select name="nmBandaraTujuan" id="nmBandaraTujuan" class="form-control select2 w-100" required>
                            ...
                            <option value="<?php echo e($bd_tujuan->jenis_id); ?>"
                                <?php if($bd_tujuan->jenis_id === $jdkeberangkatan->bandara_tujuan): ?> selected <?php endif; ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 ">
                        <input type="text" id="nmTKI" name="nmTKI" value="<?php echo e($jdkeberangkatan->name); ?>"
                            class="form-control h-45 border-form bg-form font-weight-500" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        <input type="date" id="nmTglLahir" name="nmTglLahir" value="<?php echo e($jdkeberangkatan->tgl_lahir); ?>"
                    ...
                    <div class="col-md-9 mt-1">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdLaki" name="nmJK" class="custom-control-input" 
                                value="L" <?php if($jdkeberangkatan->jk === "L"): ?> checked <?php endif; ?>>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdPerempuan" name="nmJK" class="custom-control-input" 
                                value="P" <?php if($jdkeberangkatan->jk === "P"): ?> checked <?php endif; ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control border-form bg-form"><?php echo e($jdkeberangkatan->alamat); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <select name="nmProvinsi" id="nmProvinsi" onchange="getKota();" class="form-control select2 w-100">
                            ...
                            <option value="<?php echo e($prov->id); ?>" 
                                <?php if($jdkeberangkatan->provinsi == $prov->id): ?> selected <?php endif; ?>><?php echo e($prov->nama); ?>
            ...
            <div class="col-md-6">
                <div class="form-group row pt-2">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="nmPaspor" name="nmPaspor" value="<?php echo e($jdkeberangkatan->paspor); ?>"
                            class="form-control h-45 border-form bg-form font-weight-500">
                    ...
                    <div class="col-md-9">
                        <select name="nmImigrasi" id="nmImigrasi" class="form-control select2 w-100">
                            ...
                            <option value="<?php echo e($imi->jenis_id); ?>" 
                                <?php if($jdkeberangkatan->kantor_imigrasi == $imi->jenis_id): ?> selected <?php endif; ?>><?php echo e($imi->name); ?>
                    ...
                    <div class="col-md-9">
                        <select name="nmPptkis" id="nmPptkis" class="form-control select2 w-100">
                            ...
                            <?php $__currentLoopData = $perusahaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prsh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prsh->id); ?>" <?php if($jdkeberangkatan->pptkis == $prsh->id): ?> selected <?php endif; ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control border-form bg-form font-weight-500"><?php echo e($jdkeberangkatan->agency); ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-3 font-15 font-weight-bold  mb-2">
                        ...
                        <select name="nmNegara" id="nmNegara" class="form-control select2 w-100">
                            ...
                            <?php $__currentLoopData = $negara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $neg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($neg->jenis_id); ?>" 
                                    <?php if($jdkeberangkatan->negara_id == $neg->jenis_id): ?> selected <?php endif; ?>><?php echo e($neg->name); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="nmNamaMajikan" name="nmNamaMajikan" value="<?php echo e($jdkeberangkatan->nama_majikan); ?>"
                ...
                <div class="form-group row pt-2">
                    ...
                    <div class="col-md-9">
                        ...
                        placeholder="Alamat Majikan"><?php echo e($jdkeberangkatan->alamat_majikan); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row pt-2">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control border-form bg-form"><?php echo e($jdkeberangkatan->kontak); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row pt-2">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control border-form bg-form"><?php echo e($jdkeberangkatan->keterangan); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="nmStatusBerangkat" id="nmStatusBerangkat" class="form-control selectric" style="font-size:16px;" >
                            <option value="0" <?php if($jdkeberangkatan->status === 0): ?> selected <?php endif; ?>>Belum Berangkat</option>
                            <option value="1" <?php if($jdkeberangkatan->status === 1): ?> selected <?php endif; ?>>Sudah Berangkat</option>
                            <option value="2" <?php if($jdkeberangkatan->status === 2): ?> selected <?php endif; ?>>Batal</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('sistem.jadwal.keberangkatan.script-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/jadwal/keberangkatan/edit.blade.php ENDPATH**/ ?>