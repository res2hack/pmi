...
<script>
    ...
    var table = $('#dt-pencaker').DataTable({
        destroy: true,
        pageLength: 25,
        processing: true,
        serverSide: true,
        ajax: {
                url: '<?php echo e(route('pencaker_json')); ?>',
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pencaker/table.blade.php ENDPATH**/ ?>