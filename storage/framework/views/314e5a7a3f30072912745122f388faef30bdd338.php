...
<div class="row">
    ...
    <div class="col-11">
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Data BLK</h4> 
            ...
            <div class="btn-group  align-top ml-2 mr-2" title="Menu">
                ...
                <div class="dropdown-menu">
                    <a href="<?php echo e(route('blk_create')); ?>" class="text-success dropdown-item" title="Buat SIP Baru"><i class="fas fa-plus mr-2 font-12"></i>Baru 
                    </a>
                    <a href="<?php echo e(route('blk_edit', $direktori->id)); ?>" class="text-primary dropdown-item" title="Ubah Data SIP"><i class="far fa-file-alt  mr-2 font-12"></i>Ubah
                    </a>
                </div>
            </div>
        </div>
            
        <span class="font-weight-500 text-primary">Detail Data BLK <i class="far fa-file-alt ml-2"></i></span>
...
<a href="<?php echo e(route('blk_index')); ?>"><u>BLK</u></a>
<i class="fas fa-angle-right mx-2"></i>
    ...
    <div class="card-body mb-4">
        <div class="row mb-2">
            <div class="col-md-12 text-right">
                <a href="<?php echo e(route('blk_index')); ?>" class="btn btn-secondary pv">
                    <i class="fas fa-chevron-left font-14"></i>
                </a>
                <a href="<?php echo e(route('blk_edit', $direktori->id)); ?>" class="btn btn-dark ml-2">
                    <span class="font-14"><i class="fas fa-edit mr-2"></i>Ubah</span>
                </a>
                
                <a href="<?php echo e(route('blk_delete')); ?>" class="btn btn-danger ml-2"
        ...
        <div class="form-group row my-0">
            <div class="py-2 col-3 font-15 font-weight-bold text-dark text-right border-right2">Nama BLK</div>
        ...
        <div class="form-group row my-0">
            <div class="py-2 col-3 font-15 font-weight-bold text-dark text-right border-right2">Pengelola</div>
            <div class="py-2 col-9 font-weight-500 text-primary">
                <?php echo e($direktori->kategori === "blk-swasta"?'Swasta':'Pemerintah'); ?>
        ...
        <div class="form-group row my-0">
            <div class="py-2 col-3 font-15 font-weight-bold text-dark text-right border-right2">Legal</div>
            <div class="py-2 col-9 font-weight-500 ">
...
<form method="POST" action="<?php echo e(route('blk_delete')); ?>">
    <?php echo csrf_field(); ?>
    <?php echo $__env->make('sistem.direktori.modal-del', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/direktori/blk/detail.blade.php ENDPATH**/ ?>