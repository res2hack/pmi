...
<a href="<?php echo e(route('master_index', 'bandara')); ?>"><u>Bandara</u></a>
<i class="fas fa-angle-right mx-2"></i>
            ...
            <div class="card shadow border-top5 border-form ">
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nmKode" value="<?php echo e($master->kode); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <select name="nmJoin1_ID" id="nmJoin1_ID" class="form-control selectric" style="font-size:16px;" >
                            <?php $__currentLoopData = $negara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($x->jenis_id); ?>" 
                                    <?php if($x->jenis_id === $master->join1_id): ?> selected <?php endif; ?>><?php echo e($x->name); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nmTag1" value="<?php echo e($master->tag1); ?>"
                                class="form-control font-weight-500 h-42 bg-form border-form">
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/master/bandara/edit.blade.php ENDPATH**/ ?>