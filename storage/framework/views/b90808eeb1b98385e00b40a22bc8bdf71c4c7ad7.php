...
<form method="POST" action="<?php echo e(route('pengumuman_restore')); ?>">
    <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <div class="font-14 font-weight-bold">
                    Anda Ingin Mengembalikan Pengumuman Ini?
                </div>
                <div class="text-success font-12 mt-1">Pengumuman akan dikembalikan</div>
...
<form method="POST" action="<?php echo e(route('pengumuman_delete')); ?>">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/pengumuman/modal-sampah.blade.php ENDPATH**/ ?>