...
<script>
    function dataPendaftar() {
        ...
        var table = $('#dt-kelulusan').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('pelatihan_kelulusan_detail_json')); ?>',
                    data: {
...
</script><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/pelatihan/kelulusan/detail-table.blade.php ENDPATH**/ ?>