...
<a href="<?php echo e(route('kabkota_index')); ?>"><u>Kabupaten / Kota</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<div class="row">
    <div class="col-md-4">
        <form method="POST" action="<?php echo e(route('kabkota_update', $kabkota->id)); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="nmStatus" value="edit">
            <input type="hidden" name="nmID" value="<?php echo e($kabkota->id); ?>">
                ...
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  id="nmKabKota" name="nmKabKota" class="form-control bg-form h-45
                            font-weight-500 border-form" required><?php echo e($kabkota->nama); ?></textarea>
                        ...
                        <select name="nmProvinsi" id="nmProvinsi" class="form-control select2">
                            <?php $__currentLoopData = $provinsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($x->id); ?>" 
                                    <?php if($kabkota->provinsi_id === $x->id ): ?> selected <?php endif; ?>>
                                    <?php echo e($x->nama); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/master/kabkota/edit.blade.php ENDPATH**/ ?>