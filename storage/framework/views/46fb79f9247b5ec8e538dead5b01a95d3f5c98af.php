        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <a href="<?php echo e(route('page_create')); ?>" class="btn btn-primary font-15 py-2" title="Buat Halaman Baru">
                                <i class="fas fa-plus mr-2"></i>Baru
                            </a>
                            <a href="<?php echo e(route('page_sampah')); ?>" class="btn btn-danger font-15 py-2 ml-2" 
                                title="Keranjang Sampah - <?php if($jumlahSampah !== 0): ?> Ada <?php echo e($jumlahSampah); ?> halaman dalam keranjang sampah <?php else: ?> Tidak Ada Sampah <?php endif; ?>">
                                <i class="fas fa-trash"></i> <span class="font-10 bg-dark rounded px-1 ml-1"><?php echo e($jumlahSampah); ?></span>
                            </a>
                            <form action="<?php echo e(route('page_search')); ?>" class="d-inline ">
                            ...
                            <?php if($page_simple->count() > 0): ?>
                                <span class="align-middle font-weight-bold ml-2 border rounded px-2" style="padding-top:10px;padding-bottom:10px;">
                                    <?php echo e(($page_simple->currentpage()-1)* $page_simple->perpage() + 1); ?>-<?php echo e(($page_simple->currentpage()-1)* $page_simple->perpage() + $page_simple->count()); ?> dari <?php echo e($page_paginate->total()); ?> halaman
                                </span>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-3">
                            <span class="float-right"><?php echo e($page_simple->links()); ?></span> 
                        </div>
                    ...
                    <div class="table-responsive mt-2">
                        <table class="table table-striped">
                            ...
                            <tbody> 
                                <?php $__currentLoopData = $page_paginate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="py-2">
                                        ...
                                        <div class="mt-1">
                                            <small><a href="<?php echo e(route('page_show', $x->slug )); ?>" target="_blank" class="font-12 text-success"><i class="fas fa-link mr-2"></i>Lihat</a></small>
                                            <small class="ml-2"><a href="<?php echo e(route('page_edit', $x->id )); ?>" class="font-12"><i class="fas fa-edit mr-2"></i>Edit</a></small>
                                            <small class="ml-2">
                                                <a href="" onclick="$('#idDelete').val(<?php echo e($x->id); ?>);" title="Hapus Halaman" 
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <?php echo e($page_paginate->links()); ?>

                        </div>
                        <div class="col-md-4 text-right pt-2">
                            <?php if($page_paginate->count() > 0): ?>
                            <span class="font-weight-bold">
                            Menampilkan <?php echo e(($page_paginate->currentpage()-1)* $page_paginate->perpage() + 1); ?>-<?php echo e(($page_paginate->currentpage()-1)* $page_paginate->perpage() + $page_paginate->count()); ?> dari <?php echo e($page_paginate->total()); ?> halaman
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
...
<form method="POST" action="<?php echo e(route('page_softdelete')); ?>">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/pages/index.blade.php ENDPATH**/ ?>