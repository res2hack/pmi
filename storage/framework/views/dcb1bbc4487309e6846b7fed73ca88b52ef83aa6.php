...
<div class="row">
    ...
    <div class="col-11">
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Direktori P3MI</h4> 
            <span class="ml-2 font-11 bg-dark rounded text-white align-top py-1 px-2">Indeks</span></div>
            
        <span class="font-weight-500 text-primary">Daftar P3MI</span>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<span class="font-weight-500">P3MI</span>
<input type="hidden" name="jenisDirektori" value="p3mi">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('tombol-baru'); ?>
<div class="float-left mr-3">
    <a href="<?php echo e(route('p3mi_create')); ?>" class="btn btn-primary font-15 py-2" title="Buat Data P3MI Baru">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\xampp\htdocs\pmi\resources\views/sistem/direktori/p3mi/index.blade.php ENDPATH**/ ?>