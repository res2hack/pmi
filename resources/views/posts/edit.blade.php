...
<input type="hidden" name="idArtikel" value="{{ $post->id }}">
    <div class="row">
        <div class="col-md-8">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="nmJudul" name="nmJudul" class="form-control h-45 border-form bg-form text-dark font-weight-500" 
                            value="{{ $post->title }} @if ($errors->has('nmJudul')){{ old('nmJudul') }}@endif"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nmJenisKategori" name="nmJenisKategori" value="{{ $post->slug }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="summernote" name="nmKonten" class="summernote">{{ $post->content }}</textarea>
                    </div>
                    <div class="form-group w-100" id="featuredImage" style="cursor:pointer !important;">
                        ...
                        <div id="image-preview" class="image-preview w-100" @if($post->img_featured)  style="background-image: url('{{ url($post->img_featured) }}');" @endif>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="metaTitle" name="metaTitle" class="form-control h-45 border-form bg-form font-weight-500"  
                            value="{{ $post->meta_title }}"   onChange="$('#jmlTitle').html($('#metaTitle').val().length);">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="metaDescription" name="metaDescription" class="form-control h-45 border-form bg-form font-weight-500" rows="5" 
                            onChange="$('#jmlDesc').html($('#metaDescription').val().length);">{{ $post->meta_description }}</textarea>
        ...
        <div class="col-md-4">
            @if($post->delete_date)
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="" onclick="$('#idRestore').val({{ $post->id }});" title="Kembalikan Artikel" 
                                    data-toggle="modal" data-target="#modalRestore" class="font-12 btn btn-lg btn-dark w-100">
                                    <i class="fas fa-times mr-2"></i>Restore
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="" onclick="$('#idDelete').val({{ $post->id }});" title="Hapus Artikel Permanen" 
            ...
            @else
                ...
                <a class="card shadow font-weight-bold font-18" 
                    href="{{ route('post_show', [$post->slug_kategori, $post->slug]) }}" target="_blank" >
                ...
                @else
                <a class="card shadow font-weight-bold font-18" 
                    href="{{ route('post_preview', $post->id) }}" target="_blank" >
                    <div class="card-body text-center">
            ...
            <div class="card shadow border-top5 border-form">
                <div class="card-body">
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="text" name="tagsfake" class="form-control d-none" value="{{ $tags }}">
                        @if ($errors->has('tags'))
                    ...
                    <div class="form-group w-100">
                        ...
                        <div id="image-preview2" class="image-preview w-100" @if($post->img_thumbnail) style="background-image: url('{{ url($post->img_thumbnail) }}');background-repeat: no-repeat;background-size: cover;" @endif>
                    ...
                    <div class="form-group">
                        ...
                        <select name="nmStatus" id="nmStatus" class="form-control selectric" style="font-size:16px;" >
                            ...
                            <option value="terbit" @if($post->status === "terbit") selected @endif>Terbit</option>
                        </select>
                        <input type="hidden" name="nmTerbitDate" value="{{ $post->published_date }}">
                    </div>
