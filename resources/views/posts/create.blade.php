            ...
            <div class="card shadow border-top5 border-form" >
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="nmJudul" name="nmJudul" class="form-control h-45 border-form bg-form font-weight-500" value="@if ($errors->has('nmJudul')){{ old('nmJudul') }}@endif"
                    ...
                    {{-- <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="cbFeatured" onclick="cekFeatured()">
                            <label class="custom-control-label" for="cbFeatured">Artikel Utama (Featured Post)</label>
                        </div>
                    </div> --}}
