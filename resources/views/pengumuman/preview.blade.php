...
<div class="row mt-3">
    <div class="col-12 text-center mt-3 bg-warning py-3">
        <span class="font-20 font-weight-700 text-white">Pratinjau Pengumuman</span>
        <p class="mb-1 text-dark">Halaman ini masih belum terbit, masih berstatus draft.</p>
        <a href="{{ route('pengumuman_edit', $pengumuman->id)}}" class=" btn-dark font-11 py-1 px-2 rounded">
