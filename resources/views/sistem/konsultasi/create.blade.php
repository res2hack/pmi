...
<form method="post" action="{{ route('konsultasi_store')}}" enctype="multipart/form-data">
@csrf
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control font-weight-500 border-form bg-form h-45"
                            name="nmJudul" value="{{ old('nmJudul') }}" required>
                    ...
                    <div class="col-md-12">
                        <select name="nmKategori" id="nmKategori" class="form-control select2 w-100" required>
                            ...
                            @foreach ($kategori as $kat)
                                <option value="{{ $kat->jenis_id }}">{{ $kat->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        ...
                        class="form-control bg-form border-form" required>{{ old('nmPertanyaan') }}</textarea>
