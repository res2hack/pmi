                ...
                <div class="card-body">
                    <div class="mt-2 table-responsive ">
                        <div class="float-left mr-3">
                            <a href="{{ route('partner_create')}}" class="btn btn-primary font-15 py-2" title="Buat SIP Baru">
...
<form method="POST" action="{{ route('partner_delete')}}">
    @csrf
