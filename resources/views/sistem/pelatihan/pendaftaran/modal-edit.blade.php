<form id="formUbahDaftar" method="POST" action="{{ route('pelatihan_pendaftaran_update')}}">
    @csrf
        ...
        <div class="modal fade" id="modalUbahStatus" tabindex="-1" role="dialog" aria-labelledby="modalUbahStatusTitle" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body font-weight-bold text-dark">
                    <h6>Anda Ingin @if($pelatihan->status_pendaftaran === "buka") 
                        <span class="text-danger">Menutup</span>  @else <span class="text-success">Membuka</span> @endif
