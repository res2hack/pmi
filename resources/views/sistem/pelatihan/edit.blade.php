...
@section('title')
Kelola Program Pelatihan - Ubah {{ $pelatihan->name }}
@endsection
...
<i class="fas fa-angle-right mx-2"></i>
<a href="{{ route('pelatihan_detail', $pelatihan->id)}}"><u>{{ $pelatihan->name }}</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="{{ route('pelatihan_update')}}" enctype="multipart/form-data">
@csrf

<input type="hidden" name="nmTipe" value="edit">
<input type="hidden" name="nmID" value="{{ $pelatihan->id }}">
            ...
            <div class="col-md-6 pb-0 border-right border-form">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="nmPelatihan" name="nmPelatihan" 
                            ...
                            value="{{ $pelatihan->name }}{{ old('nmPelatihan') }}">
                                ...
                                @foreach ($kejuruan as $x)
                                    <optgroup label="{{ $x->name }}">
                                        @foreach ($sub_kejuruan as $y)
                                            ...
                                            <option value="{{ $x->jenis_id }}|{{ $y->jenis_id }}"
                                                @if($y->jenis_id === $pelatihan->sub_kejuruan_id) selected @endif>
                                                {{ $y->name }}
                                            </option>
                                            @endif
                                        @endforeach
                        ...
                        <div>
                            <select name="nmSumberDana" id="nmSumberDana" class="form-control select2 w-100">
                                ...
                                @foreach ($sumber_dana as $sd)
                                    <option value="{{ $sd->jenis_id }}" 
                                        @if($sd->jenis_id === $pelatihan->sumber_dana_id) selected @endif>
                                        {{ $sd->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-9">
                        <select name="nmMetode" id="nmMetode" class="form-control select2 w-100">
                            ...
                            @foreach ($metode as $met)
                                <option value="{{ $met->jenis_id }}" 
                                    @if($met->jenis_id === $pelatihan->metode_pelatihan_id) selected @endif>
                                    {{ $met->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group mb-2">
                            <div class="input-group mb-2">
                                <input type="number" id="nmKuota" name="nmKuota"  value="{{ $pelatihan->kuota_peserta }}"
                                    class="form-control h-45 border-form bg-form text-form font-weight-500">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group mb-2">
                            <div class="input-group mb-2">
                                <input type="number" id="nmJamPelajaran" name="nmJamPelajaran"  value="{{ $pelatihan->jam_pelajaran }}"
                                    class="form-control h-45 border-form bg-form text-form font-weight-500">
                                <div class="input-group-append">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form text-form font-weight-500" 
                        value="{{ $pelatihan->tgl_mulai }}{{ old('nmTglMulai') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="date" id="nmTglSelesai" name="nmTglSelesai" 
                            class="form-control h-45 border-form bg-form text-form font-weight-500" 
                            value="{{ $pelatihan->tgl_selesai }}{{ old('nmTglSelesai') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control h-45 border-form bg-form text-form font-weight-500">{{ $pelatihan->keterangan }}</textarea>
                    ...
                    <div class="col-md-9">
                        <div>
                            <select name="nmStatusPelatihan" id="nmStatusPelatihan" 
                                ...
                                <option value="">- Pilih -</option>
                                <option value="batal" @if($pelatihan->status_pelatihan === "batal") selected @endif>Batal</option>
                                <option value="draft" @if($pelatihan->status_pelatihan === "draft") selected @endif>Draft</option>
                                <option value="valid" @if($pelatihan->status_pelatihan === "valid") selected @endif>Valid</option>
                                <option value="selesai" @if($pelatihan->status_pelatihan === "selesai") selected @endif>Selesai</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<script>
    function statusPendaftaran(){
        ...
        $status_pendaftaran = '{{ $pelatihan->status_pendaftaran }}';
