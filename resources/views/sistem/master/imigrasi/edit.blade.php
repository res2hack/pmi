...
<a href="{{ route('master_index', 'imigrasi')}}"><u>Kantor Imigrasi</u></a>
<i class="fas fa-angle-right mx-2"></i>
                ...
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="nmKeterangan1" class="form-control font-weight-500 
                                bg-form border-form" rows="3">{{ $master->keterangan1 }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="nmKeterangan2" class="form-control font-weight-500 
                                bg-form border-form" rows="3">{{ $master->keterangan2 }}</textarea>
                    </div>
...
@section('script')
    @include('sistem.master.imigrasi.table')
@endsection