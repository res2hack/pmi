...
<a href="{{ route('kecamatan_index')}}"><u>Kecamatan</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<div class="row">
    <div class="col-md-4">
        <form method="POST" action="{{ route('kecamatan_update', $kecamatan->id )}}">
            @csrf
                ...
                <div class="card-body mt-0 pb-1 ">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  id="nmKecamatan" name="nmKecamatan" class="form-control bg-form 
                            h-45 font-weight-500 border-form" required>{{ $kecamatan->nama }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="nmKabKota" id="nmKabKota" class="form-control select2">
                            @foreach ($kabkota as $x)
                                <option value="{{ $x->id}}" 
                                    @if($x->id === $kecamatan->kabkota_id) selected @endif>
                                    {{ $x->nama }}
                                </option>
                            @endforeach
                        </select>
