...
<script>
    ...
    $(document).ready(function() {
        ...
        var kota = {!! $pengaduan->kabkota?:0 !!};
        var url =  "{{ route('pengaduan_get_kab')}}";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var kecamatan = {!! $pengaduan->kecamatan?:0 !!};
        var url =  "{{ route('pengaduan_get_kecamatan')}}";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var desa = {!! $pengaduan->desa?:0 !!};
       
        var url =  "{{ route('pengaduan_get_desa')}}";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var pekerjaan = {!! $pengaduan->pekerjaan?:0 !!};
        
        var url =  "{{ route('pengaduan_get_pekerjaan')}}";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
...
<script>
    ...
    $(document).ready(function() {
        ...
        var url =  "{{ route('pengaduan_pptkis')}}";
        $.ajax({
            url : url,
            type : "GET",
            data: {     
