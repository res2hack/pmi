        ...
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Data BLK</h4> 
            ...
            <div class="btn-group  align-top ml-2 mr-2" title="Menu">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('blk_create')}}" class="text-success dropdown-item" title="Buat Data Baru"><i class="fas fa-plus mr-2 font-12"></i>Baru 
                    </a>
                    <a href="{{ route('blk_detail', $direktori->id)}}" class="text-primary dropdown-item" title="Lihat Detail Data BLK"><i class="far fa-file-alt  mr-2 font-12"></i>Detail
                    </a>
                </div>
            </div>
        </div>
...
<a href="{{ route('blk_index')}}"><u>BLK</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="{{ route('blk_update', $direktori->id)}}" enctype="multipart/form-data">
@csrf
...
<div class="card shadow  border-top5 border-form">
    ...
    <div class="card-body">
        <div class="text-right">
            <a href="{{ route('blk_detail', $direktori->id)}}" title="Batal Ubah Data">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-md-3 mt-2 font-15 font-weight-bold text-dark mb-2">Nama BLK</div>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 my-1 font-weight-bold text-dark">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdSwasta" name="nmPengelola" class="custom-control-input" value="blk-swasta"
                                    @if($direktori->kategori === "blk-swasta") checked @endif>
                            <label class="custom-control-label" style="cursor:pointer;" for="rdSwasta">Swasta</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdNegeri" name="nmPengelola" class="custom-control-input" value="blk-negeri"
                                    @if($direktori->kategori === "blk-negeri") checked @endif>
                            <label class="custom-control-label" style="cursor:pointer;" for="rdNegeri">Pemerintah</label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 my-1 font-weight-bold text-dark">
                        ...
                        <div class="ml-3 custom-control custom-checkbox custom-control-inline">
                            ...
                            <label class="custom-control-label" for="cbValid" style="cursor:pointer;">Legal</label>
                        </div>
                    </div>
                </div>
            </div>
