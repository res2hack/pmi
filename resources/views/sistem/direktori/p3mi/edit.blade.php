        ...
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Data P3MI</h4> 
            ...
            <div class="btn-group  align-top ml-2 mr-2" title="Menu">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('p3mi_create')}}" class="text-success dropdown-item" title="Buat Data Baru"><i class="fas fa-plus mr-2 font-12"></i>Baru 
                    </a>
                    <a href="{{ route('p3mi_detail', $direktori->id)}}" class="text-primary dropdown-item" title="Lihat Detail Data P3MI"><i class="far fa-file-alt  mr-2 font-12"></i>Detail
                    </a>
                </div>
            </div>
        </div>
...
<a href="{{ route('p3mi_index')}}"><u>P3MI</u></a>
<i class="fas fa-angle-right mx-2"></i>
...
<form method="post" action="{{ route('p3mi_update', $direktori->id)}}" enctype="multipart/form-data">
@csrf
...
<div class="card shadow  border-top5 border-form">
    ...
    <div class="card-body">
        <div class="text-right">
            <a href="{{ route('p3mi_detail', $direktori->id)}}" title="Batal Ubah Data">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="form-group row">
                    <div class="col-md-3 mt-2 font-15 font-weight-bold text-dark mb-2">Nama P3MI</div>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 my-1 font-weight-bold text-dark">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdPusat" name="nmKantor" class="custom-control-input" 
                                    value="p3mi-pusat" @if($direktori->kategori === "p3mi-pusat") checked @endif>
                            <label class="custom-control-label" style="cursor:pointer;" for="rdPusat">Pusat</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="rdCabang" name="nmKantor" class="custom-control-input" 
                                    value="p3mi-cabang" @if($direktori->kategori === "p3mi-cabang") checked @endif>
                            <label class="custom-control-label" style="cursor:pointer;" for="rdCabang">Cabang</label>
                        </div>
                    </div>
                </div>
            </div>
