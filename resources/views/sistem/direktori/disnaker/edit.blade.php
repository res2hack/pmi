        ...
        <div class="mb-1 text-dark"><h4 class="d-inline">Kelola Data Disnaker</h4> 
            ...
            <div class="btn-group  align-top ml-2 mr-2" title="Menu">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('disnaker_create')}}" class="text-success dropdown-item" title="Buat Data Baru"><i class="fas fa-plus mr-2 font-12"></i>Baru 
                    </a>
                    <a href="{{ route('disnaker_detail', $direktori->id)}}" class="text-primary dropdown-item" title="Lihat Detail Data Disnaker"><i class="far fa-file-alt  mr-2 font-12"></i>Detail
                    </a>
                </div>
            </div>
        </div>
...
<form method="post" action="{{ route('disnaker_update', $direktori->id)}}" enctype="multipart/form-data">
@csrf
...
<div class="card shadow  border-top5 border-form">
    ...
    <div class="card-body">
        <div class="text-right">
            <a href="{{ route('disnaker_detail', $direktori->id)}}" title="Batal Ubah Data">
