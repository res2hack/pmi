...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('theme/frontend/assets/img/brand/favicon.png')}}" type="image/png"><!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('theme/assets/font-awesome/font-awesome-5.15/all.min.css') }}">
    <!-- Quick CSS -->
    <link rel="stylesheet" href="{{ asset('theme/frontend/assets/libs/bootstrap/dist/css/bootstrap.min.css')}}" id="stylesheet">
    <link rel="stylesheet" href="{{ asset('theme/frontend/assets/css/quick-website.css')}}" id="stylesheet">
    <link rel="stylesheet" href="{{ asset('theme/frontend/assets/css/styleku.css')}}" id="stylesheet">
    @yield('style')
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ route('home')}}">
                <img alt="Image placeholder" src="{{ asset('theme/frontend/assets/img/brand/logo.png')}}" id="navbar-logo" class="h-100">
            </a>
            <!-- Toggler -->
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mt-4 mt-lg-0 ml-auto">
                    <li class="nav-item ">
                        <a class="nav-link text-primary" href="{{ route('home')}}">Depan</a>
                    </li>
                    <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                        ...
                        <div class="dropdown-menu dropdown-menu-single">
                            <a href="{{ url('p/profil-upt')}}" class="dropdown-item">UPT</a>
                            <a href="{{ url('p/visi-misi')}}" class="dropdown-item">Visi Misi</a>
                            <a href="{{ url('p/tupoksi')}}" class="dropdown-item">Tupoksi</a>
                            <!-- <div class="dropdown-divider"></div>
                            <a href="login.html" class="dropdown-item">Login</a> -->
                        </div>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link text-primary" href="{{ route('post_portal')}}">Berita & Artikel</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link text-primary" href="{{ route('pengumuman_front')}}">Pengumuman</a>
                    </li>
                    <li class="nav-item ">
            ...
            <div class="container pt-4">
                <div class="row">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <!-- Theme's logo -->
                        <!-- <a href="index.html">
                            <img alt="Image placeholder" src="{{ asset('theme/frontend/assets/img/brand/light.svg')}}" id="footer-logo">
                        </a> -->
                        <!-- Webpixels' mission -->
    ...
    <script src="{{ asset('theme/frontend/assets/libs/jquery/dist/jquery.min.js') }}"></script>
    <script src="{{ asset('theme/frontend/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('theme/frontend/assets/libs/svg-injector/dist/svg-injector.min.js') }}"></script>
    
    <!-- Quick JS -->
    <script src="{{ asset('theme/frontend/assets/js/quick-website.js') }}"></script>
