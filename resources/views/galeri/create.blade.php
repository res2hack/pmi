...
<div class="row">
    ...
    <div class="col-11">
        ...
        <span class="font-weight-500 text-primary">Buat Halaman Baru</span>
...
<form method="post" action="{{ route('page_store')}}" enctype="multipart/form-data">
@csrf

<input type="hidden" name="page_tipe" value="baru">
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow border-top5 border-form" >
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nmJenisKategori" name="nmJenisKategori" value="{{ old('nmJenisKategori') }}"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="metaTitle" name="metaTitle" class="form-control h-45 border-form bg-form font-weight-500"  
                            value="{{ old('metaTitle') }}"   onChange="$('#jmlTitle').html($('#metaTitle').val().length);">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="metaDescription" name="metaDescription" class="form-control h-45 border-form bg-form font-weight-500" rows="5" 
                            onChange="$('#jmlDesc').html($('#metaDescription').val().length);">{{ old('metaDescription') }}</textarea>
