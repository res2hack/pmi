...
<div class="row">
    ...
    <div class="col-11">
        ...
        <span class="font-weight-500">Daftar Halaman Yang Telah Dihapus <i class="fas fa-trash text-danger ml-2"></i></span>
    </div>
</div>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <a href="{{ route('page_index')}}" class="btn btn-dark font-15 py-2" title="Kembali ke Halaman Indeks">
                                <i class="fas fa-arrow-left mr-2"></i>Kembali
                            </a>
                            <form action="{{ route('page_search_sampah')}}" class="d-inline ">
                                <input type="hidden" name="idpage" value="sampah">
                            ...
                            @if($page_simple->count() > 0)
                                <span class="align-middle font-weight-bold ml-2 border rounded px-2" style="padding-top:10px;padding-bottom:10px;">
                                    {{ ($page_simple->currentpage()-1)* $page_simple->perpage() + 1 }}-{{ ($page_simple->currentpage()-1)* $page_simple->perpage() + $page_simple->count()  }} dari {{ $page_paginate->total() }} artikel
                                </span>
                            @endif
                        </div>
                        <div class="col-md-3">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    <td class="py-2">
                                        ...
                                        <div class="mt-1">
                                            <small class="ml-2"><a href="{{ route('page_edit', $x->id )}}" class="font-12"><i class="fas fa-angle-right mr-2"></i>Detail</a></small>
                                            <small class="ml-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right pt-2">
                            ...
                            Menampilkan {{ ($page_paginate->currentpage()-1)* $page_paginate->perpage() + 1 }}-{{ ($page_paginate->currentpage()-1)* $page_paginate->perpage() + $page_paginate->count()  }} dari {{ $page_paginate->total() }} artikel
                            </span>
                            @endif
                        </div>
                    </div>
